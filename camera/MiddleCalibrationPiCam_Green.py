...
def middle_calibration_green(frame, tolerance=20):
    # Calibration constants for distance calculation
    KNOWN_DISTANCE = 50.0  # Distance to object in cm during calibration
    KNOWN_WIDTH = 4.9  # Width of object in cm during calibration
    FOCAL_LENGTH = 1473.67  # Replace with your calculated focal length
    ...
    # Define HSV range for blue
    lower_blue = np.array([35, 50, 50])  # Adjusted for lighter and darker blue
    upper_blue = np.array([85, 255, 255])  # Adjusted for lighter and darker blue
    ...
    if pi_or_usbcam == 1:
        ...
        try:
            while True:
                ...
                position, distance, processed_frame, mask = middle_calibration_green(frame)
